    ...
    getViewElement(own = true){
        ...
        switch (this.type){
            ...
            case 'audio':
                            ...
                            <div class="_2jfIu">
                                <div class="_2cfqh">
                                    <div class="_1QMEq _1kZiz fS1bA">
                                        <div class="E5U9C">
                                            <svg class="_1UDDE js-audio-load" width="34" height="34" viewBox="0 0 43 43">
                                                <circle class="_3GbTq _37WZ9" cx="21.5" cy="21.5" r="20" fill="none" stroke-width="3"></circle>
                                            </svg>
                                            <button class="_2pQE3 js-audio-play" style="display:none">
                                            ...
                                            <button class="_2pQE3 js-audio-pause" style="display:none">
                                        ...
                                        <div class="_1_Gu6">
                                            ...
                                            <div class="_1sLSi">
                                                ...
                                                <audio preload="auto" class="js-audio" src="${this.content}">
                ...
                let audioEl = div.querySelector('.js-audio');
                let loadEl = div.querySelector('.js-audio-load');
                let btnPlay = div.querySelector('.js-audio-play');
                let btnPause = div.querySelector('.js-audio-pause');
        ...
        let spanTime = div.querySelector('.message-time');
        if (own){
            className = 'message-out';
            spanTime.parentElement.appendChild(this.getStatusViewElement());            
        }
        spanTime.innerHTML = Format.timeStampToTime(this.timeStamp);
        ...
        return new Promise((s, f)=>{
            Message.getRef(chatId).add({
                ...
                docRef.set({
                    ...
                    merge:true //altera somente o status, mateem os outros dados
                }).then(()=>{
                    s(docRef);
                });
            });
                ...
                case 'sent':
                    div.innerHTML = `
                            <span data-icon="msg-check">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 15" width="16" height="15">
                                    <path fill="#02a60b" d="M10.91 3.316l-.478-.372a.365.365 0 0 0-.51.063L4.566 9.879a.32.32 0 0 1-.484.033L1.891 7.769a.366.366 0 0 0-.515.006l-.423.433a.364.364 0 0 0 .006.514l3.258 3.185c.143.14.361.125.484-.033l6.272-8.048a.365.365 0 0 0-.063-.51z"></path>
                                </svg>
                            </span>
                            `;
                    break;    
